...
public class MyActionBarDrawerToggle extends android.support.v4.app.ActionBarDrawerToggle {

    private static final String TAG = MyActionBarDrawerToggle.class.getName();
    ...
    public MyActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, DrawerArrowDrawable drawerImage, int openDrawerContentDescRes, int closeDrawerContentDescRes) {
        super(activity, drawerLayout, R.drawable.ic_drawer_am, openDrawerContentDescRes, closeDrawerContentDescRes);
        mActivity = activity;
    ...
    @SuppressLint("NewApi") protected void setActionBarUpIndicator() {
        if (mActivity != null) {
            try {
    ...
    @SuppressLint("NewApi") protected void setActionBarDescription() {
